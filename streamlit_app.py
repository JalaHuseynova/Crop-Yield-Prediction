...
Original file is located at
    https://colab.research.google.com/drive/1oA-C-v-r5oY92iFMxYEyMm52LVwNWvhw
"""
...
# 
# # Qovluğu tapmaq (Colab və ya GitHub üçün universal)
# try:
...
#         data.columns = data.columns.str.strip() # Sütun adlarını təmizləyir
#         return data
#     return None
# 
# @st.cache_resource
...
# 
# filtered_df = df # Default olaraq hamısı
# 
# if df is not None:
...
#     """)
#     # Şəkil faylı yoxdursa xəta verməməsi üçün yoxlama
...
#     else:
#         st.error(f"CSV file '{csv_name}' missing! Please upload it to the directory.")
# 
# # PAGE 3: YIELD PREDICTION
# elif page == "Yield Prediction":
#     st.title("🤖 Prediction Sandbox")
# 
#     if df is None:
#         st.error("Dataset required for options selection is missing.")
#     elif model is None:
...
#                 # Modelin gözlədiyi formatda boş bir DataFrame yaradırıq
#                 input_df = pd.DataFrame(columns=model.feature_names_in_)
#                 input_df.loc[0] = 0 # Bütün sütunları 0 edirik
# 
#                 # Əsas xüsusiyyətləri doldururuq
#                 input_df['Year'] = in_year
#                 input_df['pesticides_tonnes'] = in_pest
#                 input_df['avg_temp'] = in_temp
#                 input_df['total_precip'] = in_rain
# 
#                 # One-Hot Encoding sütunlarını 1 edirik
#                 area_col = f"Area_{in_country}"
#                 item_col = f"Item_{in_item}"
# 
